  ...
  locations: [
    {
      ...
      x: -96, z: -108,
      tagline: 'Fast hands above the clouds.',
      description:
        'From lightning-quick plays to game-changing shots, experience the thrill and intensity of basketball at Vivum. Roll up your sleeves — it’s time to hit the court and bring the heat!',
      date: DATES,
      venue: 'Basketball Court',
      rules: [
        'Team strength: 12 players.',
        'Ball size for girls: 6 · ball size for boys: 7.',
        '4 quarters of 8 minutes each, with a 5-minute half-time.',
        'Knockout tournament.',
        'FIBA rules followed, with a few exceptions.',
  ...
  links: [
    {
      ...
      url: 'https://forms.cloud.microsoft/Pages/DesignPageV2.aspx?subpage=design&FormId=jgbSOiU_hk2ePRxkXvnrgKYHdc4cd-FPvrQfigzveYBUQVhXTkUwU0tMTkkzQ1VKNUNYQzFMS1M4Qi4u&Token=9db8720df5ee41a29ca25a10fd400bf0',
      kind: 'registration',
    },
    {
  ...
  locations: [
    {
      ...
      description:
        'Channel your inner hero in a test of resilience and strength in this year’s edition of the iconic VIVIUM event!',
      date: DATES,
    ...
    },
    {
      ...
      description:
        'Introducing a new twist to this memorable VIVIUM event! Create a rap on spot to a beat and be prepared to incorporate new words thrown your way into your performance.',
      date: DATES,
      venue: 'RadioShack Stage',
      rules: [
        'Participation: Individual',
